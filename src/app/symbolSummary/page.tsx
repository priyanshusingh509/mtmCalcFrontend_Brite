    ...
    return(
      <div className='h-screen flex flex-col'>
        ...
        <div className="flex flex-col flex-grow">
          <TradeGrid mobColDef={columnDefs} fileColDef={columnDefs} requestName={tableUsed} requestType={'table'} pageIndex={pageIndex} summaryType='symbol' setTableUsed={setTableUsed}/>
        </div>
      </div>
    )
}